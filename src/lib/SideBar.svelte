<script>
  ...
  import {handleSignOut} from "./api/HandleChat"
  let spanClass = 'flex-1 ml-3 whitespace-nowrap';
</script>

<Sidebar >
  <SidebarWrapper class="h-screen w-60">
    <SidebarGroup>
      <SidebarItem label="Dummy Side Bar">
      ...
      <SidebarItem on:click={handleSignOut} label="Log out">
        <svelte:fragment slot="icon">
